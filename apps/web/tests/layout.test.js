...
(async()=>{
     ...
     and the assertion that matters is the one that passes on the second pass. */
  {
    ...
    ok("…on a spring long enough to see it settle, not a blink", lively.dur>0.35, String(lively.dur)+"s");
    ok("…and leaving is quicker than arriving, which is what stops a bounce feeling like a delay",
    ...
    ok("…in either direction, and it takes the label fade back too",
